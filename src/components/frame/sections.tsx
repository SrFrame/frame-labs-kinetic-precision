...
const projects = [
  ...
  {
    tag: "Client Project",
    title: "Gráfica Caiuás",
    cat: "Sistema Interno / Automação",
    text: "Sistema interno desenvolvido para substituir o processo manual de criação de comandas em Word, tornando a operação mais rápida, organizada e padronizada.",
  },
